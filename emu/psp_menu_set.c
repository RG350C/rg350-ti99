...
psp_settings_menu_validate(void)
{
  ...
  fprintf(stderr, "VALIDATE CONFIG: TI99.psp_cpu_clock: %u\n", TI99.psp_cpu_clock);
  fprintf(stderr, "VALIDATE CONFIG: TI99.danzeff_trans: %u\n", TI99.danzeff_trans);
  fprintf(stderr, "VALIDATE CONFIG: TI99.psp_skip_max_frame: %u\n", TI99.psp_skip_max_frame);
  fprintf(stderr, "VALIDATE CONFIG: TI99.ti99_snd_enable: %u\n", TI99.ti99_snd_enable);
  fprintf(stderr, "VALIDATE CONFIG: TI99.ti99_render_mode: %u\n", TI99.ti99_render_mode);
  fprintf(stderr, "VALIDATE CONFIG: TI99.ti99_speed_limiter: %u\n", TI99.ti99_speed_limiter);
  fprintf(stderr, "VALIDATE CONFIG: TI99.ti99_view_fps: %u\n", TI99.ti99_view_fps);
  fprintf(stderr, "VALIDATE CONFIG: TI99.ti99_vsync: %u\n", TI99.ti99_vsync);
...
psp_settings_menu(void)
{
  ...
  fprintf(stderr, "DISPLAY CONFIG: psp_cpu_clock: %u\n", psp_cpu_clock);
  fprintf(stderr, "DISPLAY CONFIG: danzeff_trans: %u\n", danzeff_trans);
  //fprintf(stderr, "DISPLAY CONFIG: psp_skip_max_frame: %u\n", psp_skip_max_frame);
  fprintf(stderr, "DISPLAY CONFIG: ti99_snd_enable: %u\n", ti99_snd_enable);
  fprintf(stderr, "DISPLAY CONFIG: ti99_render_mode: %u\n", ti99_render_mode);
  fprintf(stderr, "DISPLAY CONFIG: ti99_speed_limiter: %u\n", ti99_speed_limiter);
  fprintf(stderr, "DISPLAY CONFIG: ti99_view_fps: %u\n", ti99_view_fps);
  fprintf(stderr, "DISPLAY CONFIG: ti99_vsync: %u\n", ti99_vsync);
